...
#include <std_msgs/msg/float32.hpp>  // Standard message for marker_size
...
private:
    ...
    rclcpp::Subscription<std_msgs::msg::Float32>::SharedPtr _marker_size_sub;
