...
// # MODIFIED SOME FROM ORIGINAL ARK ELECTRONICS CODE #
// # MOSTLY THE PART THAT SWITCH TARGET DYNAMICALLY ACCORDING TO STATE MANAGER #
// # AND THE MARKER SIZE, WHICH IS IMPORTANT FOR RELATIVE DISTANCE CALCULATION #
