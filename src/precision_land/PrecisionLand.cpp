 ...
 ****************************************************************************/
	 ...
	 , _node(node)
 {
	...
	// # SEARCHING PATTERN CHANGED, ADDED HOVER ACTION, ADDED LOGGING AT function *calculateVelocitySetpointXY()* #
	// # AS WELL AS SELECTING EITHER OF THE TARGET POSE ESTIMATION FROM ARUCO MARKER IMAGE PROCESSING #
	// # ACCORDING TO CAMERA SELECTED (bnw / color) #

	// # CAN BE IMPROVED BY LIMITING APPROACH VELOCITY (SOMETIMES IT IS TOO AGGRESSIVE)
	// # THE YAW ALIGNMENT IS PRE ALIGNED VIA OFFBOARD IN STATE MANAGER #
	// # BECAUSE THIS POSITION SETPOINT YAW ALIGNMENT SOMEHOW TO AGGRESSIVE #
	// # WHEN CENTER OF GRAVITY SHIFTED, CAN RESULT IN CRASH DUE TO UNSTABLE RESPONSE #
