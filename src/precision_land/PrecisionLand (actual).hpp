...
public:
	...
	void targetPoseCallbackColor(const geometry_msgs::msg::PoseStamped::SharedPtr msg);
	void targetPoseCallbackBnW(const geometry_msgs::msg::PoseStamped::SharedPtr msg);
	void cameraSelectorCallback(const std_msgs::msg::String::SharedPtr msg);
...
private:
	...
	// ros2
	rclcpp::Node& _node;
	rclcpp::Subscription<geometry_msgs::msg::PoseStamped>::SharedPtr _target_pose_sub_color;
	rclcpp::Subscription<geometry_msgs::msg::PoseStamped>::SharedPtr _target_pose_sub_bnw;
	rclcpp::Subscription<std_msgs::msg::String>::SharedPtr _camera_selector_sub;
	rclcpp::Subscription<px4_msgs::msg::VehicleLandDetected>::SharedPtr _vehicle_land_detected_sub;
	rclcpp::Subscription<std_msgs::msg::Float64MultiArray>::SharedPtr _angle_sub;
	...
	std::string _selected_camera = "color_camera";  // Default to color camera (plug first)
	...
	float _z_from_aruco;  // Add this line to store the original_z
	double _cclength = 0.0;		// distance from bnw_camera center to gripper center (horizontally)
	double _x_offset = 0.0;
	double _y_offset = 0.0;
	double _z_offset = 0.0;
	double _angle_value = 0.0;  // Variable to store the received angle
