...
# LAUNCH FILE, COMMENT UNCOMMENT SELECTIVELY #
...
# THERE'S ANOTHER GIT FOR SIMULATION #


# THE /cfg/param.yaml IN aruco_tracker AND precision_land ARE IMPORTED AS DEFAULT PARAMETERS #
# CAN ADJUST FOR DEFAULT SETTING CHANGE #
